...
Creates a new QR code instance.
    ...
    element: The HTML element where the QR code will be rendered.
    options: An object with the following properties:
    text: The text or URL to encode in the QR code. 
    width: The width of the QR code.
    height: The height of the QR code.
    colorDark: The color of the dark modules. (optional, default: #000000)
    colorLight: The color of the light modules. (optional, default: #ffffff)
